...
build (){
    ...
    answers.push(getHtmlCheckboxKeys(name, this.shuffleArrayKeys(this.data.items), currentQuestion.numbering));
    answers.push(`</div>`);
...
* **** */
 reloadQuestion() {
    ...
    obFamille.innerHTML = getHtmlCheckboxKeys(name, this.shuffleArrayKeys(this.data.items), currentQuestion.numbering);
    return true;
}
