...
<tbody>
<tr>
<td colspan="1" rowspan="3" style="vertical-align: top;width:40px;text-align:center">{title}{listeItems}</td>
...
var tplButton = `<img class="${prefix}quizBtn01" src="../images/buttons/${currentQuestion.options.btnColor}/btn_{moveTo}.png" onclick="quiz_MoveItemTo('{id}','{moveTo}');">`;
    ...
    var html = tblHtml.replace('{listeItems}', listItems).replace('{title}', currentQuestion.options.title);
    return html;
}  
/* *************************************
*
