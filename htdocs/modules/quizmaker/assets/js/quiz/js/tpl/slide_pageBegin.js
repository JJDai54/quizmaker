...
var name = this.getName();
      ...
      //answers.push(`<br><button id="startQuiz"  name="startQuiz" class="quizButton saumon-itemButton" style="font-size:1.8em;visibility: visible; display: inline-block;" onclick='showNextSlide();'>${quiz_messages.btnStartQuiz}</button>`);
      answers.push(`<br><button id="startQuiz"  name="startQuiz" class="quizButton ${quiz.theme}-itemButton" style="font-size:1.8em;visibility: visible; display: inline-block;">${quiz_messages.btnStartQuiz}</button>`);//       if(this.typeForm == 3){
