...
const answers = [];
    ...
    for(var k = 0; k< newKeys.length; k++){
        ...
        answers.push(`<tr>`);
        answers.push(`<td style="text-align:right;width:10%;"">${getNumAlpha(k,currentQuestion.numbering)} : </td>
                     <td width='30%'><input type="text" id="${textId}"  name="${textName}" value="${newKeys[k]}" class="question-matchItems" disabled>
                     </td>`);       
...
reloadQuestion_old(quizBoxAllSlides) {
    var currentQuestion = this.question;
