...
*/
class memory_grille extends Plugin_Prototype{
name = "memory_grille";
memoryIsLoad = false;
totalMinoration = 0;
...
computeScoresMinMaxByProposition(){
    ...
    if(currentQuestion.points > 0){
        ...
        this.scoreMaxiBP = currentQuestion.answers[0].points * (options.imgCols * options.imgRows);
    }
    this.scoreMiniBP = 0;
...
onFinalyse (){
    ...
    var tellFrom = `memory.onFinalyse[${this.gameId}]`; // pour tracer et debuger
