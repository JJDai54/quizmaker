...
getInnerHTML(){
    ...
    var captionBottom = '';   
    var tHtml = [];   
      tHtml.push(`<div class='quiz_slide_listboxClassItems_main'>` ); 
 ...
 prepareData(){
   ...
   //repartir les proposition par group
    for(var k in currentQuestion.answers){
        ...
        groupsArr[ans.group*1].push(ans);
    }   
...
*
* ******** */
computeScoresMinMaxByProposition2(){
...
//alert('nbgroupe = ' + this.data.groups.length);
    ...
    for(var i=0; i < this.data.groups.length; i++) {
        ...
        tGroups[i]  = this.data.groups[i].libelle + "<br>"
                    + formatArray0(tAns, "","");
    }
    
    return tGroups.join("<hr>");
