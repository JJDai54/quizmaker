...
//------------------------------------------------------------------
define('_LG_PLUGIN_SELECTIMAGES', "Question à réponses uniques ou multiples classic oou en images");
...
define('_LG_PLUGIN_SELECTIMAGES_TYPE_AUTO', "Aumatique");
define('_LG_PLUGIN_SELECTIMAGES_TYPE_CHECKBOX', "Choix multiple");
define('_LG_PLUGIN_SELECTIMAGES_TYPE_RADIO', "Choix unique");
define('_LG_PLUGIN_SELECTIMAGES_TYPE_DESC', "Automatique caclul le type en fonction du nombre de réponses qui ont un nombre de points supérieur à 0<br>1 = boutons radio<br>2 ou plus : cases à cocher");

define('_LG_PLUGIN_SELECTIMAGES_TYPE_2', "Choix unique et passage au slide suivant");

define('_LG_PLUGIN_SELECTIMAGES_VARIANT_CLASSIC', "Coches et radios classiques");
