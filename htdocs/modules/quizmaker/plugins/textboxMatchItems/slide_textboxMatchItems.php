...
* *********************************************************** */
 	public function getFormOptions($caption, $optionName, $jsonValues = null)
 	{
      ...
      $labComparaison = new xoopsFormLabel('', _QT_QUIZMAKER_TEXTBOXMATCHITEMS_COMPARAISON);
      $trayOptions->addElement($labComparaison);     
      
      $name = 'comparaison';  
      $inputComparaison = new XoopsFormRadio('', "{$optionName}[{$name}]", $tValues[$name], '<br>');
      $inputComparaison->addOption("0", _QT_QUIZMAKER_TEXTBOXMATCHITEMS_COMPARAISON_0);            
      $inputComparaison->addOption("1", _QT_QUIZMAKER_TEXTBOXMATCHITEMS_COMPARAISON_1);            
      $inputComparaison->addOption("2", _QT_QUIZMAKER_TEXTBOXMATCHITEMS_COMPARAISON_2);            
