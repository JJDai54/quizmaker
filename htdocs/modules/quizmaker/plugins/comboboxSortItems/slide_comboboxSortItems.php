...
include_once QUIZMAKER_PATH_MODULE . "/plugins/listboxSortItems/slide_listboxSortItems.php";
...
* *********************************************************** */
 	public function getFormOptions($caption, $optionName, $jsonValues = null)
 	{
      ...
      $name = 'ordre';  
      $inputOrder = new \XoopsFormRadio(_QT_QUIZMAKER_COMBOBOXSORTITEMS_SORT, "{$optionName}[{$name}]", $tValues[$name], ' ');
