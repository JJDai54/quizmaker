 ...
 */
class slide_radioMultiple extends XoopsModules\Quizmaker\Type_question
{
...
//       $name = 'orientation';  
//       $inputOrientation = new \XoopsFormRadio(_CO_QUIZMAKER_TYPE_RADIOMULTIPLE_ORIENTATION, "{$optionName}[{$name}]", $tValues[$name], ' ');
//       $inputOrientation->addOption("H", _CO_QUIZMAKER_TYPE_RADIOMULTIPLE_ORIENTATION_H);            
//       $inputOrientation->addOption("V", _CO_QUIZMAKER_TYPE_RADIOMULTIPLE_ORIENTATION_V);            
//       $trayOptions->addElement($inputOrientation);     

      $name = 'orientation'; 
      $path = $this->pathArr['img'] . "/dispositions"; 
      $inputOrientation = new \XoopsFormIconeSelect("<br>" . _CO_QUIZMAKER_TYPE_RADIOMULTIPLE_ORIENTATION. "-" . $tValues[$name], "{$optionName}[{$name}]", $tValues[$name], $path);
