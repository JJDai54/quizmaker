...
define('_LG_PLUGIN_SELECTINPUTS_TYPE_DESC', "");
define('_LG_PLUGIN_SELECTINPUTS_TYPE_0', "Choix multiple");
define('_LG_PLUGIN_SELECTINPUTS_TYPE_1', "Choix unique");
define('_LG_PLUGIN_SELECTINPUTS_TYPE_2', "Choix unique et passage au slide suivant");

define('_LG_PLUGIN_SELECTINPUTS_NEXT_SLIDE', "Message");
define('_LG_PLUGIN_SELECTINPUTS_NEXT_SLIDE_DESC', "Message affiché si c'est une question à choix unique avec passage au slide suivant.");
define('_LG_PLUGIN_SELECTINPUTS_MSGBG', "Couleur de fond du message.");
