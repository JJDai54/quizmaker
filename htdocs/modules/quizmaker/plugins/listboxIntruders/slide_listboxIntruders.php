 ...
 */
class slide_listboxIntruders extends XoopsModules\Quizmaker\Type_question
{
	...
	{
        parent::__construct("listboxIntruders", 0, "listbox");
...
* *********************************************************** */
 	public function getFormOptions($caption, $optionName, $jsonValues = null)
 	{
      ...
      $inputGroupDefault->addOption(2, (($tValues['group2']) ? $tValues['group2'] : 'group2'));            
