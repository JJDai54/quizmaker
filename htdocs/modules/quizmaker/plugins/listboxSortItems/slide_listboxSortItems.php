 ...
 */
class slide_listboxSortItems extends XoopsModules\Quizmaker\Type_question
{
...
* *********************************************************** */
 	...
 	{      
      ...
      $name = 'btnColor';  
      $btnColors = XoopsLists::getDirListAsArray(QUIZMAKER_PATH_QUIZ_ORG . '/images/buttons', '');
      ...
      $trayHeight1 = new \XoopsFormElementTray(_AM_QUIZMAKER_BTN_HEIGHT, $delimeter = ' ');  
