...
define('_LG_PLUGIN_FINDOBJECTS_DESC', "Ce slide est composé d'une ou deux images. Il faut retroiuver les objets cachés ou différents.");
...
define('_LG_PLUGIN_FINDOBJECTS_NEXT_SLIDE_DELAI_DESC', "<b>délai = 0</b> : l''utiilisateur doit lui même appuyer sur le bouto suivant.<br><b>délai > 0</b> : le passage au slide suivant sera automatique dans deux cas : l'utilisatuer à tout bon, l'utilisatuer a épuisé le nombre de test possible.");
...
define('_LG_PLUGIN_FINDSOBJECTS_NEXTSLIDE_AUTO_DESC', "<b>Non</b> : L'utilisateur doit cliquer sur le bouton suivant.<br><b>Oui</b> : Le passage au slide suivant sera automatique dans deux cas :<br>1) Le nombre d'essais a été atteind,<br>2) Tous les objets ont été trouvés.");
...
define('_LG_PLUGIN_FINDOBJECTS_NEXT_QUESTION_MAX0', "Vous avez atteind le nombre d'essais maximum {max}//Question suivante !");
define('_LG_PLUGIN_FINDOBJECTS_NEXT_QUESTION_MAX1', "Vous avez atteind le nombre d'essais maximum {max} dont {winning} / {length} de bons//Question suivante !");
