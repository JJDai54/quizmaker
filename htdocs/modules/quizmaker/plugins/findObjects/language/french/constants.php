...
define('_LG_PLUGIN_FINDOBJECTS_NEXT_SLIDE_DELAI_DESC', "<b>délai = 0</b> : l''utilisateur doit lui même appuyer sur le bouton suivant. Les option suivantes sont inutiles.<br><b>délai > 0</b> : le passage au slide suivant sera automatique dans deux cas avec le message appropré suivant.");
...
define('_LG_PLUGIN_FINDOBJECTS_INFO', "Vous avez fait {total} essais sur {max}//dont {winning} objets trouvés sur {length} !");
 ...
 define('_LG_PLUGIN_FINDOBJECTS_NEXT_QUESTION_WIN_0', "Bravo !//Vous avez trouvé {winning} / {length} objets//Question suivante !");
 define('_LG_PLUGIN_FINDOBJECTS_NEXT_QUESTION_WIN_1', "Vous avez trouvé {winning} / {length} objets//On passe à la suite");
 define('_LG_PLUGIN_FINDOBJECTS_NEXT_QUESTION_WIN_2', "Vous avez fait {total}/{max} essais dont {winning} objets trouvés sur {length}//Question suivante");

 define('_LG_PLUGIN_FINDOBJECTS_NEXT_QUESTION_MAX_0', "Dommage !//Vous avez atteint le nombre d'essais maximum {max}//Question suivante !");
 define('_LG_PLUGIN_FINDOBJECTS_NEXT_QUESTION_MAX_1', "Vous avez atteint le nombre d'essais maximum {max}//dont {winning} / {length} de bons//Question suivante !");
 define('_LG_PLUGIN_FINDOBJECTS_NEXT_QUESTION_MAX_2', "Vous avez fait {total}/{max} essais dont {winning} objets trouvés sur {length}//Question suivante !");
