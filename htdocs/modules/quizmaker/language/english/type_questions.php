...
define('_CO_QUIZMAKER_TYPE_CHECKBOX_DESC', "This slide is composed of a question and several checkboxes.");
define('_CO_QUIZMAKER_TYPE_PAGEINFO_DESC', "This silde has several features: Intro page, insert and results.<br>The page type is defined in the slide options.\"
...
define('_CO_QUIZMAKER_TYPE_CHECKBOX', "Multiple Answer Question");
...
define('_CO_QUIZMAKER_TYPE_MATCHITEMS', "Match items two by two");
define('_CO_QUIZMAKER_TYPE_MATCHITEMS_DESC', "This slide is composed of a list of terms to which the terms of another list must be associated<br>Each term of the second list is a mixed list of the terms of the first list. ");
define('_CO_QUIZMAKER_TYPE_MULTITEXTBOX', "Multiple questions with multiple answers.");
define('_CO_QUIZMAKER_TYPE_MULTITEXTBOX_DESC', "This slide is composed of one or more questions.<br>Each question can have several enterable answers.");
...
define('_CO_QUIZMAKER_TYPE_SORTCOMBOBOX', "Sort multiple list");
define('_CO_QUIZMAKER_TYPE_SORTCOMBOBOX_DESC', "This slide is made up of several lists made up of the same terms.<br>You must indicate the specific order in the question<br>The order can be reversed if the option has been defined." );
define('_CO_QUIZMAKER_TYPE_TEXTAREA', "Correct text");
define('_CO_QUIZMAKER_TYPE_TEXTAREA_DESC', "This slide is composed of a text area that must be corrected directly.");
