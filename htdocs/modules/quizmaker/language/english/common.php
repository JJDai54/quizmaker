...
//define('_CO_QUIZMAKER_SHOW_SAMPLE_BUTTON_DESC', "If yes, the \"Add sample data\" button will be visible to the administrator. It is Yes by default for the first installation.");
...
define('_CO_QUIZMAKER_TYPE_QUESTION_DESC', "You can change the question type but be careful not all types are compatible<br>For example the radioSimple type is not compatible with the textboxSimple type.<br>The risk when changing the type is losing the answers and having to re-enter them.");
