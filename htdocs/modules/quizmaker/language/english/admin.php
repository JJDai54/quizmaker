...
define('_AM_QUIZMAKER_LEGEND', "Léende");
...
define('_AM_QUIZMAKER_VISIBLE_DESC', "La question ne sera pas générr dans le quiz.");
...
define('_AM_QUIZMAKER_QUIZ_EXECUTION', "Exécution");
define('_AM_QUIZMAKER_QUIZ_EXECUTION_DESC', "Défini le mode d'xécution, dans l'interface du site ou en indépenament du site<br>en mode indépendant, les scores ne seront pas engistrés");
