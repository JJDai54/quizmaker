...
define('_CO_QUIZMAKER_TYPE_PAGEBEGIN', "Page de présentation du quiz");
define('_CO_QUIZMAKER_TYPE_PAGEBEGIN_DESC', "Ce slide permet de présenter le quiz; Il est obligatoire et doit être placé en premeir.");
define('_CO_QUIZMAKER_TYPE_PAGEBEGIN_EXAMPLE', "");

define('_CO_QUIZMAKER_TYPE_PAGEEND', "Page de résultat du quiz");
define('_CO_QUIZMAKER_TYPE_PAGEEND_DESC', "Ce slide permet d'afficher les résultats du quiz. il est obligatoire et doit être le dernier slide car il active le bouton de validation qui permet d'enregistrer le résultat dans la base.");
define('_CO_QUIZMAKER_TYPE_PAGEEND_EXAMPLE', "");

define('_CO_QUIZMAKER_TYPE_PAGEGROUP', "Page de regroupement de questions");
define('_CO_QUIZMAKER_TYPE_PAGEGROUP_DESC', "Ce slide permet de regrouper plusieur questions. Il peut être invisible. Il permet notamment de déplacer un groupe de question. s'il est visible il permet de présenter le groupe de questions.");
define('_CO_QUIZMAKER_TYPE_PAGEGROUP_EXAMPLE', "");

define('_CO_QUIZMAKER_TYPE_CHECKBOXSIMPLE', "Question à réponses multiples");
define('_CO_QUIZMAKER_TYPE_CHECKBOXSIMPLE_DESC', "Ce slide est composé d'une question et de plusieurs cases à cocher.");
...
define('_CO_QUIZMAKER_TYPE_CHECKBOXLOGICAL_DESC', "Ce slide est composé de deux listes :<br>- une liste de termes ayant des points communs<br>- une deuxième liste dont un seul terme possède les mêmes points communs<br>Il faut cocher toutes les options qui ont également ces points communs.");
...
define('_CO_QUIZMAKER_TYPE_COMBOBOXMATCHITEMS', "Associer les éléments deux à deux");
...
define('_CO_QUIZMAKER_TYPE_TEXTBOXMULTIPLE', "Questions multiples à réponses multiples.");
define('_CO_QUIZMAKER_TYPE_TEXTBOXMULTIPLE_DESC', "Ce slide est composé d'une ou plusieurs questions.<br>Chaque question peut avoir plusieurs réponses saisissables.");
define('_CO_QUIZMAKER_TYPE_TEXTBOXMULTIPLE_EXAMPLE', "");

define('_CO_QUIZMAKER_TYPE_TEXTBOXMATCHITEMS', "Associer les éléments deux à deux");
...
define('_CO_QUIZMAKER_TYPE_TEXTBOXMATCHITEMS_EXAMPLE', "");
...
define('_CO_QUIZMAKER_TYPE_RADIOMULTIPLE2_DESC', "Ce slide est composé de plusieurs liste avec un nombre identique de termes.<br>Il faut retouver les termes qui vont ensemble.<br>Plusieurs solutions peuvent être proposées avec un nombre de points différent.");
...
define('_CO_QUIZMAKER_TYPE_COMBOBOXSORTLIST', "Trier une liste multiple");
define('_CO_QUIZMAKER_TYPE_COMBOBOXSORTLIST_DESC', "Ce slide est composé de plusieurs liste constitué des même termes.<br>Il faut indiquer l'ordre précicé dans la question<br>L'ordre peut être inverse si l'option a été définie.");
define('_CO_QUIZMAKER_TYPE_COMBOBOXSORTLIST_EXAMPLE', "");

define('_CO_QUIZMAKER_TYPE_TEXTAREASIMPLE', "Corriger le texte");
define('_CO_QUIZMAKER_TYPE_TEXTAREASIMPLE_DESC', "Ce slide est composé d'une zone de texte qu'il faut corriger directement.");
