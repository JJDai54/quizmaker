...
\define('_AM_QUIZMAKER_QUIZ_SHOW_TYPE_QUESTION_DESC', "Affiche le type de question dans l'entête du slide sous la question. Affiche également l'id du quiz et de la question");
...
\define('_AM_QUIZMAKER_SHOW_BTN_GOTO_SLIDE_DESC', "Affiche le bouton \"Goto Slide\".");
