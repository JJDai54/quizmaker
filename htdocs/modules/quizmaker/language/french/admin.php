...
define('_AM_QUIZMAKER_QUIZ_RESULTATS_DESC', "<ul style='text-align: left;'><li><span style='font-size: large; font-family: arial, helvetica, sans-serif;'>Nombre de r&eacute;ponses faites : {repondu} / {totalQuestions}</span><br /><span style='font-size: large; font-family: arial, helvetica, sans-serif;'></span></li><li><span style='font-size: large; font-family: arial, helvetica, sans-serif;'><strong>Votre score est de {score} / {scoreMaxi}</strong><span style='color: #ff0000;'> (score minimum : {scoreMini})</span> </span><br /><span style='font-size: large; font-family: arial, helvetica, sans-serif;'></span></li><li><span style='font-size: large; font-family: arial, helvetica, sans-serif;'>Votre temps de r&eacute;ponse est de {duree}</span></li></ul>");
...
\define('_AM_QUIZMAKER_Orientation_H', "Orientation horizontale");
\define('_AM_QUIZMAKER_Orientation_V', "Orientation verticale");
...
\define('_AM_QUIZMAKER_VIEW_ALL_SOLUTIONS_DESC', "<b>Oui</b> : Permet d'afficher les solutions qui ne rapportent pas de points ou qui ont une note négative<br><b>Non</b> : Affiche que les solutions qui ont une note positive");
