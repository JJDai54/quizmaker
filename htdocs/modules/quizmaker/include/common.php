...
define('QUIZMAKER_PATH_QUIZ_MIN', QUIZMAKER_PATH_MODULE . QUIZMAKER_FLD_QUIZ_JS . QUIZMAKER_FLD_QUIZ_MIN);
...
define('QUIZMAKER_BIT_SHOWSCOREMINMAX', $h++);
define('QUIZMAKER_BIT_SHOWALLSOLUTIONS', $h++);
...
$h = 0;
define('QUIZMAKER_BIT_SHOWTYPEQUESTION', $h++);
define('QUIZMAKER_BIT_SHOWRELOADANSWERS', $h++);
define('QUIZMAKER_BIT_SHOWGOTOSLIDE', $h++);
define('QUIZMAKER_BIT_SHOWGOODANSWERS', $h++);
define('QUIZMAKER_BIT_SHOWBADANSWERS', $h++);
define('QUIZMAKER_BIT_SHOWLOG', $h++);
define('QUIZMAKER_BIT_SHOWRESULTALLWAYS', $h++);
define('QUIZMAKER_BIT_SHOWREPONSESBOTTOM', $h++);
