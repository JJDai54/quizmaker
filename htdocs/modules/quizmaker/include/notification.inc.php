...
function quizmaker_notify_iteminfo($category, $item_id)
{
	...
	if (!defined('QUIZMAKER_URL')) {
		define('QUIZMAKER_URL', XOOPS_URL . '/modules/quizmaker');
	}
	...
	switch($category) {
		...
		case 'quiz':
			...
			$item['url']  = QUIZMAKER_URL . '/quiz.php?quiz_id=' . $item_id;
			return $item;
		break;
		case 'categories':
			...
			$item['url']  = QUIZMAKER_URL . '/categories.php?cat_id=' . $item_id;
			return $item;
		break;
	}
	return null;
