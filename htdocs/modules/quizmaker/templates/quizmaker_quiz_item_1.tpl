...
<{/if}>
            ...
            <td width="30%">
                  <{if $Quiz.publishQuiz == 1}>
                      <a class='run_quiz' href="<{$smarty.const.QUIZMAKER_DISPLAY_QUIZ}>?op=run&quiz_id=<{$Quiz.id}>" >
                        <{$Quiz.name}>
                      </a>
            ...
            <td class='left' width="100px">
                ...
                <{if $Quiz.periodeOK}>
                  <{if $Quiz.publishQuiz == 1}>
                      <a class='run_quiz' href="<{$smarty.const.QUIZMAKER_DISPLAY_QUIZ}>?op=run&quiz_id=<{$Quiz.id}>&cat_id=<{$Quiz.cat_id}>&player_id=<{$playerId}>" >
                          <img src="<{$modUrlImages}>/run_quiz_01.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_RUN_QUIZ}>' height='16px'/>
                          <img src="<{$modUrlImages}>/run_quiz_00.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_RUN_QUIZ}>' height='16px'/>
                  ...
                  <{elseif $Quiz.publishQuiz == 2}>
                      <a class='run_quiz' href='<{$Quiz.quiz_html}>' title='<{$smarty.const._MA_QUIZMAKER_RUN_QUIZ}>' target='blank'>
                          <img src="<{$modUrlImages}>/run_quiz_02.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_RUN_QUIZ}>' height='16px'/>
                          <img src="<{$modUrlImages}>/run_quiz_00.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_RUN_QUIZ}>' height='16px'/>
                          <{$smarty.const._MA_QUIZMAKER_RUN}>
                      </a>
                  <{else}>
            ...
            <br>
                <{if $Quiz.publishResultsOk}>
                  <a class='run_quiz' href="results.php?op=list&cat_id=<{$Quiz.cat_id}>&player_id=<{$player_id}>&quiz_id=<{$Quiz.id}>&sender=quiz_id" >
                      <img src="<{$modUrlIcon16}>/sigma-01.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_RESULTS}>' height='16px'/>
                      <img src="<{$modUrlIcon16}>/sigma-02.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_RESULTS}>' height='16px'/>
            ...
            <br>
                <{if $Quiz.publishAnswersOk}>
                    <a class='run_quiz' href='solutions.php?quiz_id=<{$Quiz.id}>&cat_id=<{$Quiz.cat_id}>&player_id=<{$player_id}>' title='<{$smarty.const._MA_QUIZMAKER_RUN_QUIZ}>' target='blank'>
                        <img src="<{$modUrlImages}>/solution-01.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_SOLUTIONS}>' height='16px'/>
                        <img src="<{$modUrlImages}>/solution-02.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_SOLUTIONS}>' height='16px'/>
                        <{$smarty.const._MA_QUIZMAKER_SOLUTIONS}>
                        
                    </a>
                <{else}>
                        <img src="<{$modUrlImages}>/solution-00.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_SOLUTIONS}>' height='16px'/>
                        <{$smarty.const._MA_QUIZMAKER_SOLUTIONS}>
                <{/if}>
            <br>
                <{if $isAdmin}>
                    <a class='run_quiz' href='admin/questions.php?op=list&sender=&cat_id=<{$Quiz.cat_id}>&quiz_id=<{$Quiz.id}> ' title='<{$smarty.const._MA_QUIZMAKER_ADMIN}>' target='blank'>
                        <img src="<{$modUrlImages}>/admin-01.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_ADMIN}>' height='16px'/>
                        <img src="<{$modUrlImages}>/admin-01.png" alt="quiz" title='<{$smarty.const._MA_QUIZMAKER_ADMIN}>' height='16px'/>
