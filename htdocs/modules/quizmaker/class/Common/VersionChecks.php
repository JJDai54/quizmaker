...
trait VersionChecks
{
     ...
     */
    public static function checkVerModule($quizHelper, $source = 'github', $default = 'master')
    {
        $moduleDirName      = basename(dirname(dirname(__DIR__)));
        $moduleDirNameUpper = mb_strtoupper($moduleDirName);
        $update             = '';
        ...
        if ('github' === $source) {
            if (function_exists('curl_init') && false !== ($curlHandle = curl_init())) {
                ...
                if (false === $curlReturn) {
                    ...
                    $moduleVersion = ($quizHelper->getModule()->getInfo('version') . '_' . $quizHelper->getModule()->getInfo('module_status'));
                    //"PHP-standardized" version
