...
public static function recurseCopy2(
    ...
    //$src.= '/';
    //$dst.='/';
    //echo "recurseCopy : <br>{$src}<br>{$dst}<hr>";
        $dir = opendir($src);
        //        @mkdir($dst);
    ...
    //echo "recurseCopy file : {$src}/{$file}<br>";
                }
            }
        }
        closedir($dir);
   ...
   * @return string[]
   */
  public static function getRecurseFiles($dirname, $extensions)
  {
      $filelist = array();
      ...
      self::getRecurseFilesByExtension($dirname, $extensionList, $filelist);
      //echo "<hr>'getRecurseFiles'<pre>" . print_r($filelist, true) . "</pre><hr>"; exit;
      //echoArray($filelist, 'getRecurseFiles', true);
      return $filelist;
  }
      ...
      if ($handle = opendir($dirname)) {
          while (false !== ($file = readdir($handle))) {
            ...
            if (($file == '.') || ($file == '..')) {
                ...
                self::getRecurseFilesByExtension($fullName, $extensionList, $filelist);  
