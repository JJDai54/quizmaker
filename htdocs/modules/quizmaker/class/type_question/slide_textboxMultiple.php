 ...
 */
class slide_textboxMultiple extends XoopsModules\Quizmaker\Type_question
{
	...
	{
        parent::__construct("textboxMultiple", 0, 500);
    }
...
//    echo "<hr>answers<pre>" . print_r($answers, true) . "</pre><hr>";
        ...
        for($h = 0; $h < $this->maxPropositions; $h++){
            ...
            $inpCaption = new XoopsFormText(_AM_QUIZMAKER_SLIDE_TITLE, $name, $this->lgProposition2, $this->lgProposition2, $caption);
            $trayCaption->addElement($inpCaption);
            
            $name = $this->getName($h, 'inputs');
            $inpInputs = new XoopsFormNumber(_AM_QUIZMAKER_SLIDE_INPUTS, $name, $this->lgPoints, $this->lgPoints, $inputs);
            ...
            for($i = 0; $i < $maxMots; $i++){
                ...
                $inpMot = new XoopsFormText(_AM_QUIZMAKER_SLIDE_MOT, $name, $this->lgMot1, $this->lgMot2, $mot);
