...
build (){
    ...
    tHtml.push(getHtmlListbox(name, id1, leftArray, keys.length, -1, quiz.numerotation, 0, extra));
    
    tHtml.push(`</td><td>`);
    
    var extra = `${click}="quiz_basculeValue('${id2}','${id1}');"`;
    tHtml.push(getHtmlListbox(name, id2, RightArray, keys.length, -1, quiz.numerotation, 0, extra));
